...
export const en = {
  ...
  emailLogin: {
    ...
    emailNotConfirmed: 'Your email is not confirmed. Please check your confirmation email.',
    tooManyRequests: 'Too many attempts. Please try again later.',
    signupDisabled: 'Email registration is currently unavailable.',
    accountAlreadyExists: 'This email is already registered. Please sign in.',
    accountUnavailable: 'This account cannot sign in right now. Please contact support.',
  ...
  login: {
    ...
    qrLogin: 'Scan QR to sign in',
    qrLoginTitle: 'QR code sign-in',
    qrDisplayHint: 'Scan this code with another device already signed in to 100 Things',
    qrWaiting: 'Waiting for confirmation…',
    qrConfirming: 'Confirmed. Signing in…',
    qrExpired: 'QR code expired',
    qrCreateFail: 'Could not load the QR code. Check your connection.',
  ...
  home: {
    scanLoginQr: 'Scan QR code',
    parentForChild: '{{me}} does this for {{name}}',
    childForParent: '{{name}} does this for {{me}}',
    togetherWith: '{{me}} and {{name}} do this together',
    more: 'More',
  ...
  settings: {
    ...
    qrLoginOtherDevice: 'Scan QR to sign in another device',
    qrGuestTitle: 'Link your account first',
    qrGuestBody: 'Guest accounts cannot sign in on another device. Link a phone number or email in Account & Security first.',
    qrScanTitle: 'Scan sign-in QR code',
    qrScanHint: 'Place the code shown on the other device inside the frame',
    qrScanInvalid: 'This is not a valid sign-in QR code',
    qrPermissionTitle: 'Camera access is needed to scan a sign-in QR code',
    qrApproveTitle: 'Confirm sign-in',
    qrApproveBody: 'Allow the other device to sign in to your account? Only continue if you are using that device.',
    qrApproveConfirm: 'Confirm sign-in',
    qrApprovedTitle: 'Sign-in confirmed',
    qrApprovedBody: 'The other device is signing in.',
    qrApproveFailTitle: 'Could not confirm',
    qrApproveFailBody: 'The code may have expired. Refresh it on the other device and try again.',
    guest: 'Guest',
    groupKids: 'Children',

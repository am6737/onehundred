...
export const en = {
  ...
  settings: {
    ...
    groupPet: 'Pet companion',
    petNote: 'Pick a little companion for each child.',
  ...
  petPicker: {
    ...
    subtitle: 'to record every little moment',
    changeTitle: 'Change pet',
    confirm: 'Choose {{name}}',
    saving: 'Saving...',
    bear: { name: 'Dango', trait: 'Gentle', desc: 'Quiet and gentle — the friend who is always there.' },
    dog: { name: 'Woof', trait: 'Playful', desc: 'Warm and excitable — a buddy who never sits still.' },
    cat: { name: 'Mimi', trait: 'Aloof', desc: 'Proud and cool outside, soft on the inside.' },
  },
};
